<?php
include 'db.php'; // ต้องแน่ใจว่าไฟล์นี้มีการสร้างตัวแปร $conn แล้ว
...
<body class="bg-gray-100">
    ...
    <nav class="bg-yellow-950 p-4 flex justify-between items-center text-white">
      ...
      <div class="hidden md:flex text-xl gap-4 space-x-4">
        ...
        <a href="items.html" class="hover:text-yellow-500">Items</a>
        ...
        <a href="cart.html" class="hover:text-yellow-500 flex"
          ><svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
    ...
    >
      <a href="index.php" class="block hover:bg-yellow-500 p-2 mobile-link"
        >Home</a
      >
      <a href="items.html" class="block hover:bg-yellow-500 p-2 mobile-link"
        >Items</a
      >
    ...
    <div class="flex justify-center items-center h-screen"><div class="bg-white p-6 rounded-lg shadow-lg w-96">
        ...
        <form method="POST">
            ...
            <button type="submit" class="w-full bg-yellow-950 text-white p-2 rounded hover:bg-yellow-500">Register</button>
        </form>

        <p class="mt-2 text-sm">Already have an account? <a href="login.php" class="text-yellow-500">Login</a></p>
    </div>
  </div>
    <!-- Footer -->
